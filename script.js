...
burger[0].addEventListener('click', () => {
  ...
  verticalMenu[0].classList.toggle("open");
  setTimeout(() => {
    anime({
      targets: ".navBarSus .vertical-menu ul li .a",
      marginLeft: 0,
      duration: 1000,
      opacity: 1,
...
burger[1].addEventListener('click', () => {
    ...
    verticalMenu[1].classList.toggle("open");
    setTimeout(() => {
      anime({
        targets: ".navBarInitial .vertical-menu ul li .a",
        marginLeft: 0,
        duration: 1000,
        opacity: 1,
        delay: anime.stagger(100)
